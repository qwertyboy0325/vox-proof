...
Last reviewed against code/evidence: application-service authority and export behavior through repository HEAD `3dbcb23`; v0.1 established by MD-008; native desktop framework and in-process integration accepted by MD-016; desktop implementation not yet present.
...
| VoxProof Desktop Application | Single native Rust process/executable containing eframe/egui presentation, direct application-service integration, and linked core semantics | Foundation accepted by MD-016; implementation pending |
...
| --- | --- | --- |
| eframe/egui Review UI | Foundation accepted by MD-016; implementation pending | Presentation and transient GUI state only; not authoritative |
...
| --- | --- | --- | --- | --- |
| Product UI (CLI prompts today; eframe/egui Review UI accepted) | Presentation, navigation, human intent capture, export triggers | Canonical decisions, reviewed SRT text, detector configuration truth | CLI established; GUI foundation accepted, implementation pending | `architecture/overview.md`; MD-002; MD-016 |
...
- [ ] Bounded owner-authorized implementation work package recorded before desktop implementation starts
