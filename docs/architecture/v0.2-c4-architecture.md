...
| 7 | Manual correction as distinct decision form | **Resolved by MD-017:** exact validated single-line payload on an existing detector-raised ReviewCase, recorded as `DecisionRecorded`, sharing canonical materialization and overlap rules | Owner-accepted at `6e395bdf9cc0a5b4333876f165280e4cc4bf506f` | HumanRaised cases, deletion, multiline editing, withdrawal, persistence, and Correction Memory remain separate | Accepted by Ezra in MD-017 |
