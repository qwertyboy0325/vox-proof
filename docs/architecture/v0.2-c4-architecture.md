...
| 4 | Session persistence format & compatibility policy | Touches MD-governed serialization boundary | JSON snapshot; SQLite; directory bundle; no persistence in v0.2 | Migration rules, partial-save semantics, corruption recovery; durability/recovery/retention requirements proposed in MD-014; mechanism still TBD | Ezra (Material Decision) |
