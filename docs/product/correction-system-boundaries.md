...
If accepted, proposed `decisions/MD-012-proposed-experience-derivation-and-scoped-knowledge-governance.md` would own the durable v0.2 boundary for correction-to-proposal separation, scoped knowledge governance, promotion and revocation and conflict semantics, and immutable knowledge snapshots. This document retains cross-version taxonomy and product boundaries; it does not duplicate MD-012 rules.
