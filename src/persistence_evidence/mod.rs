...
pub use current_contract::{
    ...
    FieldClassification, MEASUREMENT_CONTRACT_VERSION, OracleViolationCodeV3,
    SCENARIO_CONTRACT_VERSION, ScenarioRequirementLevel, VARIANT_PROMOTED_ACTIVE,
    all_fixture_variants, build_candidate_rejected_state, build_duplicated_session_lineage_state,
